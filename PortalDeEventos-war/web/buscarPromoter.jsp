                ...
                <div class="eventos">
                    <c:forEach var="promoter" items="${listaUsuarios}">
                        <c:if test="${promoter.getFkTipousuario().getIdTipousuario()== 2}">
                            ...
                            <div class="etitulo">
                                <p> nome: ${promoter.getUsuarioinfo().getNome()}
                            </div>
                            ...
                            <div class="ecaixa">  
                                <form action="FrontController" method="POST">
                                  ...
                                  s  <p><input type="hidden" name="idPromoter" value="${promoter.getIdUsuario()}"/></p>
                                ...
                                <p> descrição: ${promoter.getUsuarioinfo().getDescricao()}
                            </div>
                        </c:if>
                    </c:forEach>
                </div>
